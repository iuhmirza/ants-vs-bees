...
class Ant(Insect):
    ...
    def add_to(self, place):
        if place.ant is None:
            ...
            # BEGIN Problem 8b
            if place.ant.is_container and not place.ant.ant_contained:
                place.ant.ant_contained = self
            elif self.is_container and not self.ant_contained:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        x = 0
        while x < self.lower_bound and currentPlace.entrance:
            currentPlace = currentPlace.entrance
            x += 1
        while self.lower_bound <= x <= self.upper_bound:
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 8a
        if other.is_container or self.ant_contained: return False
        else: return True
        # END Problem 8a
